...
class QFRET:
    ...
    WALLET_AUTH_ERR     = "2520"
    WALLET_BALANCE_ERR  = "2521"
    WALLET_WD_AMT_SMALL = "2522"
    WALLET_WD_AMT_BIG   = "2523"
    WALLET_WD_FREQUENTLY= "2524"
    WALLET_WITHDRAW_ERR = "2530"
    SERVERERR           = "2600"
    METHODERR           = "2601"
    NOCOMPLETE          = "2602"
...
error_map = {
    ...
    QFRET.WALLET_AUTH_ERR       : u"授权失败",
    QFRET.WALLET_BALANCE_ERR    : u"余额不足",
    QFRET.WALLET_WD_AMT_SMALL   : u"提现金额太少",
    QFRET.WALLET_WD_AMT_BIG     : u"提现金额太多",
    QFRET.WALLET_WD_FREQUENTLY  : u"提现太频繁",
    QFRET.WALLET_WITHDRAW_ERR   : u"提现失败",
    QFRET.SERVERERR             : u"内部错误",
    QFRET.METHODERR             : u"函数未实现",
    QFRET.NOCOMPLETE            : u"操作未完成",
}
